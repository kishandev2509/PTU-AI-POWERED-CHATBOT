...
EMAIL_PASSWORD = "ghj jhf hjg bhj dsf"    # Replace with your Gmail App Password
    ...
    try:
        ...
        try:
            ...
            with smtplib.SMTP(SMTP_SERVER, SMTP_PORT) as server:
                ...
                print(f"Support email sent successfully to {ADMIN_EMAILS}")
            return jsonify({'success': True, 'message': 'Email sent successfully'})
        except smtplib.SMTPAuthenticationError as e:
            print("SMTP Authentication Error: Please check your email credentials")
            print(traceback.format_exc())
            return jsonify({'success': False, 'message': 'Email authentication failed. Please check server configuration.'})
